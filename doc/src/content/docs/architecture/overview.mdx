...
| Power control | WR11AS panel rocker, hand-wired through Board L J5 | Fused positive feed / switched V15 return; Board P remains powered |
...
The [WR11AS rocker](./power-switch.mdx) turns off the LED driver and MCU supply
by opening Board L’s fused positive feed. Board P remains connected to USB-PD.
The rocker is a separate hand-assembled panel part; ON restarts the MCU after sufficient rail decay; rapid toggles need verification.
