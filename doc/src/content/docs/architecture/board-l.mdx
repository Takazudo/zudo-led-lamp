...
The enclosure-mounted [WR11AS power rocker](./power-switch.mdx) disconnects both
converters after F1; J5 provides its two hand-wire solder points. The PCB now places
SW1 and J5 on the rear, leaving the LEDs facing the light chamber. See the
...
`EC11L1525G01` ([C2991196](https://jlcpcb.com/partdetail/C2991196)), quadrature
encoder (detent/pulse count unresolved — see caveat below), panel-mount bushing.
...
| `V15_FUSED` | `F1.2 J5.1 SW2.1a` | Fused positive feed to the external rocker |
| `V15` | `SW2.1b J5.2 D10.cathode C10.1 C11.1 U2.VIN(8) RS1.1 D11.cathode C12.1 C13.1 U4.VIN(3) C14.1` | The board's 15 V rail. D10 = second SMAJ20A local to Board L, clamping cable-inductance transients the harness can develop |
