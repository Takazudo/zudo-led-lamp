...
The rear PCB [C496154 power toggle](./power-switch.mdx) disconnects both
converters after F1. SW1 and SW2 are on the rear, leaving the LEDs facing the light chamber. See the
...
| `V15_FUSED` | `F1.2 SW2.2` | Fused positive feed to the toggle common |
