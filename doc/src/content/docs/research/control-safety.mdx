...
## Current potentiometer fault boundary

R22 (100 kΩ) pulls BRIGHT_ADC down and C22 (100 nF) filters it; an open wiper
decays toward dark with nominal 10 ms RC. R27 is 100 Ω in series. This does not
identify every fault: a stuck wiper or short to V3P3 can resemble a valid setting.
Validate ADC acquisition/calibration, clamp readings, retain independent PD and
thermal gates, and keep PWM off until startup checks pass.
