...
| JOUT1 | XFCN PZ254V-11-06P male | [C492405](https://jlcpcb.com/partdetail/XFCN-PZ254V_1106P/C492405) | THT 1x6, 2.54 mm | Direct downstream board interface | 98,021 (live 2026-08-20) |
...
an XFCN PZ254V-11-06P male (6-pin, 2.54 mm pitch, 3 A/contact) that directly mates with
Board L's PM254V-11-06-H85 female. Both exact parts were in ample stock when checked on
2026-08-20. The pair removes the unresolved cable BOM, but it is unkeyed: layout alignment,
pin-1 orientation, standoff, and retention are explicit pre-power gates.
...
is the PD contract cap of 3.0 A at 15 V. The XFCN pair is rated 3.0 A/contact; at an
