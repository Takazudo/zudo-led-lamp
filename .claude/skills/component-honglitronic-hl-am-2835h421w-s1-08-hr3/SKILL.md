...
Run the central validator and read every local JSON file before using these records. Official primary specifications support the Honglitronic base-MPN LED limits and the exact FOJAN order code and ballast ratings. The exact C210315-to-3000 K distributor/bin binding and real eight-branch current sharing remain open.
