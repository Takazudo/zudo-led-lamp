...
Run the central validator and read all local JSON before using this record. Murata's current primary part list confirms exact identity, NRND status, 10 kOhm nominal resistance, B-value context, and maximum measurement current.
