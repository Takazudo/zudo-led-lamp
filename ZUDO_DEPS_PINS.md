...
- pinned: 50cbd5c6c9e5a795d72a74a855e105e4939d4eab (zudo-doc-v5.27.0)
- updated: 2026-09-24
- sync: generate an external create-zudo-doc@5.27.0 default scaffold with --yes --no-install --no-git, then reconcile this route
...
- pinned: 50cbd5c6c9e5a795d72a74a855e105e4939d4eab (zudo-doc-v5.27.0)
- updated: 2026-09-24
- notes: Invoked by pnpm check:links (advisory) and pnpm check:anchors (strict anchors, after build in b4push and CI). Keep existing strict generated-reference and CI warning gates. Version 5.27.0 fixes the escaped-underscore TOC mismatch; the copied checker uses the shared extractAllHeadingIds API.
